    ...
    content: (
      <>
        <Safari
          src={`/dashboard.png`}
          url="https://acme.ai"
          className="-mb-32 mt-4 max-h-64 w-full px-4 select-none drop-shadow-[0_0_28px_rgba(0,0,0,.1)] group-hover:-translate-y-2.5 transition-all duration-300"
        />
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <Safari
          src={`/dashboard.png`}
          url="https://acme.ai"
          className="-mb-48 ml-12 mt-16 h-full px-4 select-none drop-shadow-[0_0_28px_rgba(0,0,0,.1)] group-hover:-translate-x-2.5 transition-all duration-300"
        />
      </>
    ),
  },
...
export default function Solution() {
  return (
    ...
    >
      <div className="mx-auto max-w-sm mt-16 grid grid-cols-1 gap-6 md:grid-cols-2 md:max-w-3xl xl:grid-rows-2 md:grid-rows-3 xl:max-w-6xl xl:auto-rows-fr xl:grid-cols-3">
